...
public class CircleCustomProgress extends View {
    ...
    public CircleCustomProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleCustomProgress(Context context, AttributeSet attrs, int defStyleAttr) {
