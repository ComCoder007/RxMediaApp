...
public class Asst_Dashboard extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate( R.layout.asst_dashboard,null,false );
    ...
    private void initilization(View v) {
      ...
      /*  StoredObjects.hashmaplist(2);
        adapter = new HashMapRecycleviewadapter(getActivity(), StoredObjects.dummy_list, "ass_dashboard", franchise_recyler, R.layout.dashboard_listitem);
                ...
                if(response.body() != null) {
                    try {
                        ...
                        if (status.equalsIgnoreCase("200")) {
                            ...
                            adapter = new HashMapRecycleviewadapter(getActivity(),data_list, "ass_dashboard", franchise_recyler, R.layout.dashboard_listitem);
                            franchise_recyler.setAdapter(adapter);
