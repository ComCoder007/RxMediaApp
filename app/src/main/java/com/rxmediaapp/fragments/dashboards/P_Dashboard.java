...
public class P_Dashboard extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate( R.layout.p_dashboard,null,false );
                ...
                if(response.body() != null) {
                    try {
                        ...
                        if (status.equalsIgnoreCase("200")) {
                            ...
                            adapter = new HashMapRecycleviewadapter(getActivity(), data_list , "p_dashboard", franchise_recyler, R.layout.dashboard_listitem);
