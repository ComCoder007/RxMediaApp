...
public class Edit_Diagnosis extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate( R.layout.edit_diagnosis,null,false );
        StoredObjects.page_type="edit_diagnosis";
    ...
    private void initilization(View v) {
        ...
        title_txt.setText( "Edit Diagnosis" );
        ...
        try {
            ...
            for (int k = 0; k < P_Diagnosis_Reports.patientslist.size(); k++) {

                if(data_list.get(0).get("name").equalsIgnoreCase(P_Diagnosis_Reports.patientslist.get(k).get("name"))){
                    patient_id=P_Diagnosis_Reports.patientslist.get(k).get("user_id");
                }
        ...
        save_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(StoredObjects.inputValidation(diagnose_date_edtx,getString(R.string.reportdate_validation),getActivity())) {
                    if (StoredObjects.inputValidation(diagnose_docname_edtx, getString(R.string.enter_dr_name), getActivity())) {
