...
import com.rxmediaapp.activities.HosptalSignup;
...
public class Add_Marketing_Exicutive extends Fragment {
      ...
      marketing_exec_image.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              if (CameraUtils.checkAndRequestPermissions(getActivity()) == true) {
                  Imagepickingpopup(getActivity(), "marketing executive");
              }
          }
      });

    title_txt.setText("Add Marketing Executive");
                    ...
                    if (StoredObjects.isValidMobile(mobile_str)) {
                        if (StoredObjects.inputValidation(me_passwd_edtx, getString(R.string.enter_pass_validation), getActivity())) {
                                    ...
                                    if (InterNetChecker.isNetworkAvailable(getContext())) {
                                        addMarketingExecutiveService(getActivity(), reference_from_str, name_str, email_str, mobile_str, aadhar_str, password_str);
                                    } else {
  ...
  private void addMarketingExecutiveService(final Activity activity, String reference_from_str, String name_str, String email_str, String mobile_str, String aadhar_str, String password_str) {
      CustomProgressbar.Progressbarshow(activity);
      APIInterface api = RetrofitInstance.getRetrofitInstance().create(APIInterface.class);


      api.addMarketingExecutives(RetrofitInstance.add_marekting_executives,reference_from_str,name_str,email_str,aadhar_str,mobile_str,password_str,StoredObjects.UserId,StoredObjects.UserRoleId).enqueue(new Callback<ResponseBody>() {
          @Override
